function [rowsol, cost, cost_matrix, intersection_ratios_im1, intersection_ratios_im2, patches_1, patches_2, prop_hogs_1, prop_hogs_2] =  get_match(im1name, im2name)
...
params = load('external/rp-master/config/rp.mat');
